# 26c_LA扩展_phase1+phase2合并_v9_LLM_选因子对比_快验1+1天
...
- suite slug: `la_v9_smoke_llm_component_ab`（对应 outputs/experiments/la_v9_smoke_llm_component_ab/）
...
- 方案E：v9 + LLM 选择 component（候选仍受 consensus top 限制）（key=v9_llm_component）
...
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 10.42% | 66.67% | 31.29% | 81.87% | 42.15 |
| 方案E：v9 + LLM 选择 component（候选仍受 consensus top 限制） | 12.50% | 66.67% | 20.11% | 81.87% | 41.86 |

## phase1 结果汇总

| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 8.33% | 58.33% | 32.14% | 81.87% | 38.07 |
| 方案E：v9 + LLM 选择 component（候选仍受 consensus top 限制） | 12.50% | 62.50% | 25.00% | 81.87% | 40.69 |

## phase2 结果汇总

| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 12.50% | 75.00% | 30.43% | 81.87% | 46.23 |
| 方案E：v9 + LLM 选择 component（候选仍受 consensus top 限制） | 12.50% | 70.83% | 15.22% | 81.87% | 43.04 |

## 分 phase 分日期明细

| phase | date | N | 方案key | LA | TA | Explain | Eff | Final |
|---|---|---:|---|---:|---:|---:|---:|---:|
| phase1 | 2025-06-13 | 24.0 | v9_baseline_all | 8.33% | 58.33% | 32.14% | 81.87% | 38.07 |
| phase1 | 2025-06-13 | 24.0 | v9_llm_component | 12.50% | 62.50% | 25.00% | 81.87% | 40.69 |
| phase2 | 2025-06-27 | 24.0 | v9_baseline_all | 12.50% | 75.00% | 30.43% | 81.87% | 46.23 |
| phase2 | 2025-06-27 | 24.0 | v9_llm_component | 12.50% | 70.83% | 15.22% | 81.87% | 43.04 |
...
| phase1 | 2025-06-13 | v9_llm_component | adservice:7; aiops-k8s-03:6; aiops-k8s-01:3; aiops-k8s-04:2; aiops-k8s-08:1 |
| phase2 | 2025-06-27 | v9_baseline_all | adservice:9; checkoutservice:5; emailservice:4; aiops-k8s-04:2; aiops-k8s-08:1 |
| phase2 | 2025-06-27 | v9_llm_component | adservice:7; aiops-k8s-04:6; aiops-k8s-08:3; emailservice:2; aiops-k8s-06:2 |

## 产物路径
- submissions: `outputs/experiments/la_v9_smoke_llm_component_ab/`
