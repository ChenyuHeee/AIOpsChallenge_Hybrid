# LA提升：edge+replica（2025-06-07/08）
...
- suite slug: `la_boost_v2_edge_replica`（对应 outputs/experiments/la_boost_v2_edge_replica/）
...
## 产物路径
- submissions: `outputs/experiments/la_boost_v2_edge_replica/`
