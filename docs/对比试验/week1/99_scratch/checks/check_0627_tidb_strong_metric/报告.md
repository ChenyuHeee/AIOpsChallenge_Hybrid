...
- suite slug: `check_0627_tidb_strong_metric_seed7`（对应 outputs/experiments/check_0627_tidb_strong_metric_seed7/）
...
|---|---:|---:|---:|---:|---:|
| Before：基线（fault-level gate） | 8.33% | 54.17% | 32.61% | 81.87% | 36.45 |
| After：kind-aware rerank（两段式） | 8.33% | 54.17% | 32.61% | 81.87% | 36.45 |
...
| phase2 | 2025-06-27 | after_kind_aware_rerank | adservice:7; checkoutservice-0:4; aiops-k8s-08:2; tidb-tidb-0:2; aiops-k8s-05:2 |

## 产物路径
- submissions: `outputs/experiments/check_0627_tidb_strong_metric_seed7/`
