...
- **phase2**:
  ...
  - dates（按天全量）: 2025-06-28
- telemetry root: `/Users/hechenyu/projects/AIOPS/data`
- suite slug: `check_0628_tidb_strong_metric_seed7`（对应 outputs/experiments/check_0628_tidb_strong_metric_seed7/）
...
|---|---:|---:|---:|---:|---:|
| Before：基线（fault-level gate） | 12.50% | 56.25% | 17.86% | 81.87% | 37.47 |
| After：kind-aware rerank（两段式） | 12.50% | 50.00% | 14.29% | 81.87% | 34.62 |
...
| phase2 | 2025-06-28 | 16.0 | after_kind_aware_rerank | 12.50% | 50.00% | 14.29% | 81.87% | 34.62 |
...
| phase2 | 2025-06-28 | after_kind_aware_rerank | aiops-k8s-04:4; tidb-tikv-0:3; aiops-k8s-08:2; cartservice:1; productcatalogservice-0:1 |

## 产物路径
- submissions: `outputs/experiments/check_0628_tidb_strong_metric_seed7/`
