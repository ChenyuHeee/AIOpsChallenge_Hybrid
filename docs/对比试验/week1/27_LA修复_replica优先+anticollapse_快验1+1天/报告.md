# 27_LA修复_replica优先+anticollapse_快验1+1天
...
- telemetry root: `../data`
- suite slug: `la_v10_quick_1p1`（对应 outputs/experiments/la_v10_quick_1p1/）
...
- 方案F：v10（replica 优先 + anti-collapse）（key=v10_replica_plus_anticollapse）
  - env: `{"RCA_COMPONENT_SOURCE": "consensus", "RCA_WINDOW_PADDING_MIN": "20", "RCA_ENABLE_MODALITY_BONUS": "0", "RCA_ENABLE_HINT_BONUS": "0", "RCA_COMPONENT_PRIOR_SCALE": "0.6", "RCA_USE_LEGACY_MEMORY": "0", "RCA_STRIP_REPLICA_SUFFIX": "0", "RCA_ENABLE_BASELINE_WINDOWS": "1", "RCA_BASELINE_GAP_MIN": "10", "RCA_BASELINE_LEN_MIN": "10", "RCA_ENABLE_FAULT_LEVEL_GATE": "1", "RCA_FAULT_LEVEL_GATE_PENALTY": "0.25", "RCA_FAULT_LEVEL_GATE_NODE_MIN_METRIC": "6.0", "RCA_FAULT_LEVEL_GATE_NODE_MIN_RATIO": "0.75", "RCA_FAULT_LEVEL_GATE_TIDB_MIN_METRIC": "3.0", "RCA_FAULT_LEVEL_GATE_TIDB_MIN_RATIO": "0.70", "RCA_ENABLE_NODE_METRIC_DOMINANCE_OVERRIDE": "1", "RCA_NODE_DOMINANCE_MIN_METRIC": "5.2", "RCA_NODE_DOMINANCE_MIN_RATIO": "0.6", "RCA_NODE_DOMINANCE_MARGIN": "0.03", "RCA_ENABLE_TIDB_METRIC_DOMINANCE_OVERRIDE": "1", "RCA_TIDB_DOMINANCE_MIN_METRIC": "2.6", "RCA_TIDB_DOMINANCE_MIN_RATIO": "0.55", "RCA_TIDB_DOMINANCE_MARGIN": "0.02", "RCA_TIDB_METRIC_SCORE_MULT": "1.8", "RCA_DISABLE_LLM": "0", "RCA_REQUIRE_LLM": "1", "RCA_LLM_PROVIDER": "deepseek", "RCA_LLM_MODEL": "deepseek-chat", "RCA_LLM_ATTEMPTS": "5", "RCA_ENABLE_BASELINE_LOGS": "1", "RCA_ENABLE_BASELINE_TRACES": "1", "RCA_ENABLE_LOG_BASELINE_CONTRAST": "1", "RCA_ENABLE_TRACE_BASELINE_CONTRAST": "1", "RCA_ENABLE_POPULAR_COMPONENT_PENALTY": "1", "RCA_POPULAR_PENALTY": "0.25", "RCA_POPULAR_PENALTY_MARGIN": "0.08", "RCA_POPULAR_PENALTY_REQUIRE_MULTIMODAL": "1", "RCA_TIDB_MIN_METRIC_SCORE": "0.8"}`

## 结果汇总（全部 phase 合并平均）

| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 10.42% | 64.58% | 27.72% | 81.87% | 40.96 |
| 方案F：v10（replica 优先 + anti-collapse） | 8.33% | 62.50% | 21.97% | 81.87% | 38.72 |

## phase1 结果汇总

| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 8.33% | 58.33% | 25.00% | 81.87% | 37.35 |
| 方案F：v10（replica 优先 + anti-collapse） | 4.17% | 58.33% | 17.86% | 81.87% | 34.97 |

## phase2 结果汇总

| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 12.50% | 70.83% | 30.43% | 81.87% | 44.56 |
| 方案F：v10（replica 优先 + anti-collapse） | 12.50% | 66.67% | 26.09% | 81.87% | 42.46 |

## 分 phase 分日期明细

| phase | date | N | 方案key | LA | TA | Explain | Eff | Final |
|---|---|---:|---|---:|---:|---:|---:|---:|
| phase1 | 2025-06-13 | 24.0 | v9_baseline_all | 8.33% | 58.33% | 25.00% | 81.87% | 37.35 |
| phase1 | 2025-06-13 | 24.0 | v10_replica_plus_anticollapse | 4.17% | 58.33% | 17.86% | 81.87% | 34.97 |
| phase2 | 2025-06-27 | 24.0 | v9_baseline_all | 12.50% | 70.83% | 30.43% | 81.87% | 44.56 |
| phase2 | 2025-06-27 | 24.0 | v10_replica_plus_anticollapse | 12.50% | 66.67% | 26.09% | 81.87% | 42.46 |
...
| phase1 | 2025-06-13 | v10_replica_plus_anticollapse | adservice:7; aiops-k8s-05:3; aiops-k8s-01:3; tidb-tikv-0:2; aiops-k8s-04:2 |
| phase2 | 2025-06-27 | v9_baseline_all | adservice:9; checkoutservice:5; emailservice:4; aiops-k8s-04:2; aiops-k8s-08:1 |
| phase2 | 2025-06-27 | v10_replica_plus_anticollapse | adservice:8; emailservice:4; checkoutservice:3; aiops-k8s-04:2; aiops-k8s-08:2 |

## 产物路径
- submissions: `outputs/experiments/la_v10_quick_1p1/`
