# 30_LA修复_过滤ipport节点token_快验1+1天
...
- telemetry root: `../data`
- suite slug: `la_v10_quick_1p1g`（对应 outputs/experiments/la_v10_quick_1p1g/）
...
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 6.25% | 70.83% | 40.68% | 81.87% | 43.09 |
...
| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 8.33% | 75.00% | 45.65% | 81.87% | 46.09 |
...
| phase2 | 2025-06-27 | 24.0 | v9_baseline_all | 8.33% | 75.00% | 45.65% | 81.87% | 46.09 |
...
## 产物路径
- submissions: `outputs/experiments/la_v10_quick_1p1g/`
