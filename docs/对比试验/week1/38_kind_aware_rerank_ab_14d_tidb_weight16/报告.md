# 38_kind_aware_rerank_ab_14d_tidb_weight16
...
|---|---:|---:|---:|---:|---:|
| Before：基线（fault-level gate） + TiDB权重1.6 | 14.67% | 52.39% | 15.34% | 81.87% | 36.55 |
| After：kind-aware rerank（两段式） + TiDB权重1.6 | 14.67% | 52.39% | 15.34% | 81.87% | 36.55 |

## phase1 结果汇总

| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| Before：基线（fault-level gate） + TiDB权重1.6 | 16.25% | 54.18% | 21.77% | 81.87% | 38.54 |
| After：kind-aware rerank（两段式） + TiDB权重1.6 | 16.25% | 54.18% | 21.77% | 81.87% | 38.54 |

## phase2 结果汇总

| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| Before：基线（fault-level gate） + TiDB权重1.6 | 13.10% | 50.60% | 8.91% | 81.87% | 34.55 |
| After：kind-aware rerank（两段式） + TiDB权重1.6 | 13.10% | 50.60% | 8.91% | 81.87% | 34.55 |
...
| phase2 | 2025-06-27 | 24.0 | before_baseline | 12.50% | 54.17% | 21.74% | 81.87% | 37.03 |
| phase2 | 2025-06-27 | 24.0 | after_kind_aware_rerank | 12.50% | 54.17% | 21.74% | 81.87% | 37.03 |
| phase2 | 2025-06-17 | 24.0 | before_baseline | 16.67% | 50.00% | 9.30% | 81.87% | 35.78 |
| phase2 | 2025-06-17 | 24.0 | after_kind_aware_rerank | 16.67% | 50.00% | 9.30% | 81.87% | 35.78 |
| phase2 | 2025-06-20 | 24.0 | before_baseline | 4.17% | 45.83% | 9.43% | 81.87% | 29.13 |
| phase2 | 2025-06-20 | 24.0 | after_kind_aware_rerank | 4.17% | 45.83% | 9.43% | 81.87% | 29.13 |
| phase2 | 2025-06-18 | 24.0 | before_baseline | 16.67% | 50.00% | 4.00% | 81.87% | 35.25 |
| phase2 | 2025-06-18 | 24.0 | after_kind_aware_rerank | 16.67% | 50.00% | 4.00% | 81.87% | 35.25 |
| phase2 | 2025-06-19 | 24.0 | before_baseline | 16.67% | 54.17% | 9.09% | 81.87% | 37.43 |
| phase2 | 2025-06-19 | 24.0 | after_kind_aware_rerank | 16.67% | 54.17% | 9.09% | 81.87% | 37.43 |
| phase2 | 2025-06-24 | 16.0 | before_baseline | 12.50% | 56.25% | 5.26% | 81.87% | 36.21 |
| phase2 | 2025-06-24 | 16.0 | after_kind_aware_rerank | 12.50% | 56.25% | 5.26% | 81.87% | 36.21 |
| phase2 | 2025-06-28 | 16.0 | before_baseline | 12.50% | 43.75% | 3.57% | 81.87% | 31.04 |
| phase2 | 2025-06-28 | 16.0 | after_kind_aware_rerank | 12.50% | 43.75% | 3.57% | 81.87% | 31.04 |
...
| phase2 | 2025-06-27 | before_baseline | adservice:7; tidb-tikv-0:5; tidb-tidb-0:4; checkoutservice-0:3; aiops-k8s-08:1 |
| phase2 | 2025-06-27 | after_kind_aware_rerank | adservice:7; tidb-tikv-0:5; tidb-tidb-0:4; checkoutservice-0:3; aiops-k8s-08:1 |
| phase2 | 2025-06-17 | before_baseline | tidb-tikv-0:9; adservice:7; tidb-tidb-0:3; checkoutservice-2:1; aiops-k8s-08:1 |
| phase2 | 2025-06-17 | after_kind_aware_rerank | tidb-tikv-0:9; adservice:7; tidb-tidb-0:3; checkoutservice-2:1; aiops-k8s-08:1 |
| phase2 | 2025-06-20 | before_baseline | adservice:7; tidb-tikv-0:5; tidb-tidb-0:3; aiops-k8s-08:3; currencyservice:1 |
| phase2 | 2025-06-20 | after_kind_aware_rerank | adservice:7; tidb-tikv-0:5; tidb-tidb-0:3; aiops-k8s-08:3; currencyservice:1 |
| phase2 | 2025-06-18 | before_baseline | tidb-tikv-0:8; adservice:7; aiops-k8s-04:2; aiops-k8s-08:2; tidb-tidb-0:2 |
| phase2 | 2025-06-18 | after_kind_aware_rerank | tidb-tikv-0:8; adservice:7; aiops-k8s-04:2; aiops-k8s-08:2; tidb-tidb-0:2 |
| phase2 | 2025-06-19 | before_baseline | tidb-tikv-0:9; adservice:7; aiops-k8s-04:3; tidb-tidb-0:1; cartservice:1 |
| phase2 | 2025-06-19 | after_kind_aware_rerank | tidb-tikv-0:9; adservice:7; aiops-k8s-04:3; tidb-tidb-0:1; cartservice:1 |
| phase2 | 2025-06-24 | before_baseline | aiops-k8s-08:3; tidb-tidb-0:2; tidb-pd-0:2; aiops-k8s-04:2; shippingservice:1 |
| phase2 | 2025-06-24 | after_kind_aware_rerank | aiops-k8s-08:3; tidb-tidb-0:2; tidb-pd-0:2; aiops-k8s-04:2; shippingservice:1 |
| phase2 | 2025-06-28 | before_baseline | tidb-tikv-0:6; aiops-k8s-04:3; tidb-tidb-0:2; aiops-k8s-08:1; productcatalogservice-0:1 |
| phase2 | 2025-06-28 | after_kind_aware_rerank | tidb-tikv-0:6; aiops-k8s-04:3; tidb-tidb-0:2; aiops-k8s-08:1; productcatalogservice-0:1 |

## 产物路径
- submissions: `outputs/experiments/38_kind_aware_rerank_ab_14d_tidb_weight16_seed7/`
