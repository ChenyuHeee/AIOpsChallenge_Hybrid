# 26a_LA扩展_phase1+phase2合并_v9_LLM_consensus_快验1+1天
...
- suite slug: `la_v9_smoke_llm_consensus`（对应 outputs/experiments/la_v9_smoke_llm_consensus/）
...
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 10.42% | 62.50% | 27.33% | 81.87% | 40.09 |

## phase1 结果汇总

| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 8.33% | 58.33% | 28.57% | 81.87% | 37.71 |

## phase2 结果汇总

| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 12.50% | 66.67% | 26.09% | 81.87% | 42.46 |

## 分 phase 分日期明细

| phase | date | N | 方案key | LA | TA | Explain | Eff | Final |
|---|---|---:|---|---:|---:|---:|---:|---:|
| phase1 | 2025-06-13 | 24.0 | v9_baseline_all | 8.33% | 58.33% | 28.57% | 81.87% | 37.71 |
| phase2 | 2025-06-27 | 24.0 | v9_baseline_all | 12.50% | 66.67% | 26.09% | 81.87% | 42.46 |
...
## 产物路径
- submissions: `outputs/experiments/la_v9_smoke_llm_consensus/`
