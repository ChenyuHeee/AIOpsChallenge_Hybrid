...
- telemetry root: `../data`
- suite slug: `la_v10_quick_1p1k`（对应 outputs/experiments/la_v10_quick_1p1k/）
...
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 8.33% | 66.67% | 35.64% | 81.87% | 41.75 |

## phase1 结果汇总

| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 8.33% | 66.67% | 32.14% | 81.87% | 41.40 |
...
|---|---|---:|---|---:|---:|---:|---:|---:|
| phase1 | 2025-06-13 | 24.0 | v9_baseline_all | 8.33% | 66.67% | 32.14% | 81.87% | 41.40 |
...
## 产物路径
- submissions: `outputs/experiments/la_v10_quick_1p1k/`
