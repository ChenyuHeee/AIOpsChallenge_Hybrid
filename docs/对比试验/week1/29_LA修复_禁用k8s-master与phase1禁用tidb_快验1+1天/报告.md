# 29_LA修复_禁用k8s-master与phase1禁用tidb_快验1+1天
...
- telemetry root: `../data`
- suite slug: `la_v10_quick_1p1f`（对应 outputs/experiments/la_v10_quick_1p1f/）
...
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 6.25% | 64.58% | 37.81% | 81.87% | 40.30 |

## phase1 结果汇总

| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 4.17% | 66.67% | 32.14% | 81.87% | 39.73 |
...
|---|---|---:|---|---:|---:|---:|---:|---:|
| phase1 | 2025-06-13 | 24.0 | v9_baseline_all | 4.17% | 66.67% | 32.14% | 81.87% | 39.73 |
...
|---|---|---|---|
| phase1 | 2025-06-13 | v9_baseline_all | adservice:7; recommendationservice-2:4; aiops-k8s-04:3; checkoutservice-0:2; emailservice:2 |
| phase2 | 2025-06-27 | v9_baseline_all | adservice:7; checkoutservice-0:4; aiops-k8s-08:2; emailservice:2; tidb-tidb-0:2 |

## 产物路径
- submissions: `outputs/experiments/la_v10_quick_1p1f/`
