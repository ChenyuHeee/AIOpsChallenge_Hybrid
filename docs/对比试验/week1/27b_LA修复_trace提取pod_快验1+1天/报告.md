...
- telemetry root: `../data`
- suite slug: `la_v10_quick_1p1b`（对应 outputs/experiments/la_v10_quick_1p1b/）
...
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 10.42% | 64.58% | 26.24% | 81.87% | 40.81 |
...
| 方案 | 平均LA | 平均TA | 平均Explain | 平均Eff | 平均Final |
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 12.50% | 70.83% | 23.91% | 81.87% | 43.91 |
...
| phase2 | 2025-06-27 | 24.0 | v9_baseline_all | 12.50% | 70.83% | 23.91% | 81.87% | 43.91 |
...
## 产物路径
- submissions: `outputs/experiments/la_v10_quick_1p1b/`
