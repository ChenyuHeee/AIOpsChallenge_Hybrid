# 26b_LA扩展_phase1+phase2合并_v9_LLM_consensus_快验1+1天_v2reason
...
- suite slug: `la_v9_smoke_llm_consensus_v2reason`（对应 outputs/experiments/la_v9_smoke_llm_consensus_v2reason/）
...
|---|---:|---:|---:|---:|---:|
| 方案D：v9 完整工程规则（metrics + logs + traces baseline 全开） | 10.42% | 66.67% | 26.63% | 81.87% | 41.68 |
...
## 产物路径
- submissions: `outputs/experiments/la_v9_smoke_llm_consensus_v2reason/`
