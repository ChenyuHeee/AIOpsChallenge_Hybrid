...
- suite slug: `tzfix_la_boost_v1`（对应 outputs/experiments/tzfix_la_boost_v1/）
...
|---|---:|---:|---:|---:|---:|
| 方案A：基线（禁用 legacy 记忆，作为新对照） | 14.58% | 89.58% | 21.54% | 81.87% | 52.01 |
| 方案B：hints 注入候选（seed=0.15） | 14.58% | 89.58% | 28.18% | 81.87% | 52.67 |
| 方案C：hints 注入 + 回退优先 hints | 14.58% | 70.83% | 19.69% | 81.87% | 44.32 |
| 方案D：hints 注入+回退优先 hints + 轻先验衰减（scale=0.7） | 10.42% | 83.33% | 15.34% | 81.87% | 47.22 |

## 分日期明细

| date | N | 方案key | LA | TA | Explain | Eff | Final |
|---|---:|---|---:|---:|---:|---:|---:|
| 2025-06-07 | 24.0 | base_safe | 20.83% | 87.50% | 28.26% | 81.87% | 54.35 |
| 2025-06-07 | 24.0 | hint_seed | 20.83% | 87.50% | 30.43% | 81.87% | 54.56 |
| 2025-06-07 | 24.0 | hint_seed_fb | 20.83% | 87.50% | 28.26% | 81.87% | 54.35 |
| 2025-06-07 | 24.0 | hint_seed_fb_p07 | 16.67% | 83.33% | 19.57% | 81.87% | 50.14 |
| 2025-06-08 | 24.0 | base_safe | 8.33% | 91.67% | 14.81% | 81.87% | 49.67 |
| 2025-06-08 | 24.0 | hint_seed | 8.33% | 91.67% | 25.93% | 81.87% | 50.78 |
| 2025-06-08 | 24.0 | hint_seed_fb | 8.33% | 54.17% | 11.11% | 81.87% | 34.30 |
| 2025-06-08 | 24.0 | hint_seed_fb_p07 | 4.17% | 83.33% | 11.11% | 81.87% | 44.30 |
...
| 2025-06-07 | hint_seed | checkoutservice:10; adservice:8; aiops-k8s-07:3; aiops-k8s-04:1; emailservice:1 |
| 2025-06-07 | hint_seed_fb | checkoutservice:10; adservice:8; aiops-k8s-07:3; aiops-k8s-04:1; emailservice:1 |
| 2025-06-07 | hint_seed_fb_p07 | checkoutservice:9; adservice:7; aiops-k8s-07:4; aiops-k8s-04:1; emailservice:1 |
| 2025-06-08 | base_safe | checkoutservice:12; adservice:8; aiops-k8s-07:2; aiops-k8s-08:1; hipstershop:1 |
| 2025-06-08 | hint_seed | checkoutservice:12; adservice:8; aiops-k8s-07:2; aiops-k8s-08:1; hipstershop:1 |
| 2025-06-08 | hint_seed_fb | checkoutservice:12; adservice:8; aiops-k8s-07:2; aiops-k8s-08:1; hipstershop:1 |
| 2025-06-08 | hint_seed_fb_p07 | checkoutservice:9; adservice:7; aiops-k8s-07:4; aiops-k8s-08:2; aiops-k8s-04:1 |

## 产物路径
- submissions: `outputs/experiments/tzfix_la_boost_v1/`
